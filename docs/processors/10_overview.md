...
- [**RPC Plugin**](./30_rpc_plugin.md): Transofmr data to the desired output using a custom-built RPC Plugin ([example usage](../../examples/rpc-processor-plugin/plugin.go)).
